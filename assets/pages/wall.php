     ...
     <div class="card mt-4">
                <div class="card-title d-flex justify-content-between  align-items-center">
                    ...
                    <div class="d-flex align-items-center p-2">
                        <img src="assets/images/profile/<?=$post['profile_pic']?>" alt="" height="35" width="35" class="rounded-circle border">&nbsp;&nbsp;<a style="font-family: 'Roboto Slab', serif; color: #3a3b3c; font-weight: 700;" href='?u=<?=$post['username']?>' class="text-decoration-none text-dark"><?=$post['first_name']?> <?=$post['last_name']?></a>
    ...
    <?php
                ...
                <div class="input-group p-2 <?=$post['post_text']?'border-top':''?>">
                        ...
                        <input type="text" class="form-control rounded-0 border-0 comment-input" placeholder="say something.."
                            ...
                            <button style="font-family: 'Roboto Slab', serif; background-color: #1ebbd7; color: white; font-weight: 500;" class="btn btn-outline-primary rounded-0 border-0 add-comment" data-page='wall' data-cs="comment-section<?=$post['id']?>" data-post-id="<?=$post['id']?>" type="button"
    ...
    <?php
        ...
        <div class="col-lg-4 col-sm-0 overflow-hidden mt-4 p-sm-0 p-md-3">
            ...
            <div class="d-flex align-items-center p-2">
                ...
                <div>&nbsp;&nbsp;&nbsp;</div>
                <div class="d-flex flex-column justify-content-center">
                <a href='?u=<?=$user['username']?>' class="text-decoration-none text-dark"><h6 style="margin: 0px; color: #3a3b3c; font-weight: 500;"><?=$user['first_name']?> <?=$user['last_name']?></h6></a>
...
<div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                        <button style="font-family: 'Roboto Slab', serif; background-color: #1ebbd7; color: white; font-weight: 500;" class="btn btn-sm  followbtn" data-user-id='<?=$suser['id']?>' >Follow</button>
